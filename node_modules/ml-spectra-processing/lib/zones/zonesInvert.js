 ...
 */
function zonesInvert(exclusions = [], options = {}) {
    let { from = Number.NEGATIVE_INFINITY, to = Number.POSITIVE_INFINITY } = options;
    if (from > to)
        [from, to] = [to, from];
    let returnExclusions = (0, zonesNormalize_1.zonesNormalize)(exclusions, { from, to });
    if (returnExclusions.length === 0)
        return [{ from, to }];
    let zones = [];
...
exports.zonesInvert = zonesInvert;
//# sourceMappingURL=zonesInvert.js.map