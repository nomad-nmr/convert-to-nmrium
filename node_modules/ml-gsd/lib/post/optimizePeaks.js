...
function optimizePeaks(data, peakList, options = {}) {
  ...
  */
    ...
    groups.forEach((peakGroup) => {
        ...
        if (x.length > 5) {
            let { peaks: optimizedPeaks } = (0, ml_spectra_fitting_1.optimize)({ x, y }, peaks, {
                shape,
                optimization,
            });
            for (let i = 0; i < peaks.length; i++) {
                results.push({
                    ...
                    width: (0, ml_peak_shape_generator_1.getShape1D)(peaks[i].shape).fwhmToWidth(optimizedPeaks[i].fwhm),
                });
            }
        }
        else {
