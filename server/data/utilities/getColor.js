...
exports.get2DColor = exports.COLORS = void 0;
exports.COLORS = [
    '#C10020',
    '#007D34',
    '#803E75',
...
function getColor(isRandom = false, usedColors = [], opacity = 100) {
    const resetColors = exports.COLORS.filter((c) => !usedColors.includes(c));
