...
exports.toJSON =
  ...
  exports.addJDF =
  exports.addJcamp =
  exports.addJcampFromURL =
  exports.DataExportOptions =
    void 0
...
function addJcamp(spectra, jcamp, options, usedColors) {
  ...
  for (let entry of entries) {
    ...
    if (
      ...
      (dependentVariables[0].components.length > 0 || dependentVariables[0].components.z.length)
    ) {
...
function getPreferences(state) {
  ...
  return {
    activeTab,
    ...(state.displayerMode === Constants_1.DISPLAYER_MODE.DM_1D ? { verticalAlign: align } : {})
  }
}
/**
 *
